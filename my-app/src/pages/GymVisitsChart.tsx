...
import { DatasetComponent, GridComponent, VisualMapComponent, TitleComponent, TooltipComponent, GraphicComponent } from 'echarts/components';
import { CanvasRenderer } from 'echarts/renderers';
import { MAIN_COLOR } from '../Layout/layoutVariables';

echarts.use([BarChart, DatasetComponent, GridComponent, VisualMapComponent, TitleComponent, TooltipComponent, CanvasRenderer, GraphicComponent]);

const GymVisitsChart: React.FC = () => {
    ...
    const onEvents = {
        click: (params: any) => {
            ...
            const sub = drilldownData.find(d => d.dataGroupId === params.data.groupId);
            if (!sub) return;
    ...
    const option: echarts.EChartsCoreOption = {
        ...
        xAxis: {
            type: 'category',
            data: ['Jan', 'Feb', 'March', 'Apr', 'Jun', 'Jul', 'Aug', 'Sep', "Oct", 'Nov', 'Dec']
        },
        yAxis: {
            type: 'value'
        },
